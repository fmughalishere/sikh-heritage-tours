...
export default function AboutPage() {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-white w-full overflow-x-hidden">
            <Navbar />
            <section className="pt-32 sm:pt-40 md:pt-48 pb-12 sm:pb-20 px-4 sm:px-10 max-w-7xl mx-auto w-full">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-24 items-center">
                    <motion.div
                        ...
                        className="w-full"
                    >
                        <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-6 select-none">
                            <span
                                className="text-white text-[10px] sm:text-xs font-black uppercase tracking-widest px-3 sm:px-4 py-1.5 sm:py-2 rounded-full shadow-sm"
                        ...
                        <h2 className="text-4xl sm:text-6xl md:text-7xl font-black tracking-tighter uppercase leading-[1.1] mb-6 sm:mb-10" style={{ color: sikhBlue }}>
                    ...
                    <motion.div
                        ...
                        className="relative w-full h-[350px] sm:h-[500px] lg:h-[650px] rounded-3xl sm:rounded-[40px] lg:rounded-[60px] overflow-hidden shadow-2xl group bg-slate-900 mt-6 lg:mt-0"
                    >
                        <img
                            src="/images/kartarpur-about.jpg"
                            className="absolute inset-0 w-full h-full object-cover grayscale-0 md:grayscale md:group-hover:grayscale-0 transition duration-700 select-none pointer-events-none transform md:group-hover:scale-105"
                            alt="Kartarpur Sahib Gurdwara"
                        />

                        <div
                            className="absolute inset-0 transition-opacity duration-500 opacity-20 md:opacity-40 md:group-hover:opacity-10"
                            style={{ backgroundColor: sikhBlue }}
                        />
                        <div className="absolute inset-4 sm:inset-8 border border-white/20 rounded-2xl sm:rounded-[32px] md:rounded-[40px] pointer-events-none" />
                    </motion.div>

                </div>
            </section>
            <section className="bg-slate-50 py-12 sm:py-24 px-4 sm:px-10 border-t border-b border-slate-100 w-full">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        <div className="space-y-3 sm:space-y-4">
                            <h3 className="text-lg sm:text-xl font-black uppercase tracking-tight" style={{ color: sikhBlue }}>
                                The First Defence
                            </h3>
                            <div className="w-12 h-1 rounded" style={{ backgroundColor: sikhGold }} />
                            <p className="text-gray-600 leading-relaxed text-sm font-medium pt-1 sm:pt-2">

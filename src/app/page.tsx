    ...
    <main className="bg-white overflow-x-hidden w-full">
      ...
      <section className="py-12 sm:py-20 md:py-32 px-4 sm:px-6 md:px-10 max-w-[1440px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          >
            <span
              style={{ color: sikhGold }}
              className="text-[10px] font-black uppercase tracking-[5px] block"
            >
              Jewels of Punjab
            </span>
            <h2
              style={{ color: sikhBlue }}
              className="text-4xl sm:text-6xl md:text-8xl font-black tracking-tighter leading-[0.95] lg:leading-[0.85]"
            >
              Reconnecting <br />
              <span style={{ color: sikhGold }}>With History.</span>
            </h2>
            <p className="text-lg md:text-xl text-slate-500 leading-relaxed font-medium">
              Sikh tourism Pakistan, heritage, and culture are the jewels of
              Punjab. Over 80% of all holy Sikh shrines are located here,
              including the blessed Janam Asthaan of Guru Nanak Dev Ji.
            </p>
          ...
          >
            <Image
              ...
              className="md:grayscale md:hover:grayscale-0 transition-all duration-700 object-cover"
              priority
            />
            <div className="absolute bottom-4 right-4 sm:-bottom-6 sm:-right-6 md:-bottom-10 md:-right-10 bg-white p-4 sm:p-8 md:p-10 rounded-2xl sm:rounded-[30px] md:rounded-[40px] shadow-2xl border border-slate-50 z-10 text-center sm:text-left">
              ...
              <p className="text-[9px] sm:text-[10px] font-bold uppercase tracking-widest text-slate-400 mt-1 sm:mt-2">
                Sikh Shrines in PK
              </p>
            </div>
          </motion.div>
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div className="space-y-6 md:space-y-8">
              <h3 className="text-3xl sm:text-5xl md:text-7xl font-black tracking-tighter leading-tight uppercase">
                Find Your <br />{" "}
                <span style={{ color: sikhGold }}>Ancestral Village.</span>
              </h3>
              <p className="text-base sm:text-lg md:text-xl text-white/70 leading-relaxed font-light">
                ...
                We help the Global Sangat bridge the gap between stories and
                reality.
              </p>

              <div className="flex flex-wrap gap-2 sm:gap-4 pt-2">
                {["United Kingdom", "United States", "Canada"].map(
                  (country) => (
                    <span
                      key={country}
                      className="bg-white/10 border border-white/10 px-4 sm:px-6 py-2 sm:py-3 rounded-full text-[9px] sm:text-[10px] font-black tracking-widest uppercase"
                    >
                      {country}
                    </span>
                  ),
              ...
              <div className="flex gap-4 sm:gap-6 items-start">
                ...
                <div>
                  <p className="font-bold text-base sm:text-lg">
                    Ancestral Roots Tracking
                  </p>
                  <p className="text-xs sm:text-sm opacity-60">
                    Walking the streets of your family's original pind.
                  </p>
                </div>
              </div>
              <div className="flex gap-4 sm:gap-6 items-start">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm opacity-60">
                    Experience the warmth of Punjab's legendary hospitality.
                  </p>
                </div>
              </div>
      ...
      <section className="py-12 sm:py-20 md:py-32 px-4 sm:px-6 md:px-10 max-w-[1440px] mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 sm:mb-16 gap-4">
          <div>
            <h2
              style={{ color: sikhBlue }}
              className="text-3xl sm:text-5xl md:text-7xl font-black tracking-tighter uppercase"
            >
          ...
          <Link
            href="/gurdwaras"
            className="group flex items-center gap-3 font-black text-[10px] uppercase tracking-widest self-start md:self-auto"
            style={{ color: sikhGold }}
          >
            View All Gurdwaras{" "}
            <ArrowRight
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-10">
          {[
            {
              name: "Nankana Sahib",
              img: "/images/nankana.jpg",
              count: "8 Gurdwaras",
            },
            {
              name: "Kartarpur Sahib",
              img: "/images/kartarpur.jpg",
              count: "Darbar Sahib",
            },
            {
              name: "Panja Sahib",
              img: "/images/panja.jpg",
              count: "Hassan Abdal",
            },
          ].map((site, idx) => (
            <motion.div
            ...
            >
              ...
              <div className="absolute bottom-6 left-6 sm:bottom-10 sm:left-10 text-white z-20">
                <p
                  style={{ color: sikhGold }}
                  className="text-[10px] font-black uppercase tracking-[3px] mb-1 sm:mb-2"
                >
                  {site.count}
                </p>
      ...
      <section className="py-12 sm:py-20 md:py-32 px-4 sm:px-6 md:px-10 max-w-[1440px] mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 sm:mb-16 gap-4">
          <div>
            <span
              style={{ color: sikhGold }}
              className="text-[10px] font-black uppercase tracking-[4px] block mb-3"
            >
